...
{
    internal static class MapProductoVigilanciaDAL
    {
        ...
        /// <param name="ds"></param>
        /// <returns></returns>
        internal static ResultadoInfo<ProductoInfo> ObtenerProductosPorPaginaCompleto(DataSet ds)
        {
