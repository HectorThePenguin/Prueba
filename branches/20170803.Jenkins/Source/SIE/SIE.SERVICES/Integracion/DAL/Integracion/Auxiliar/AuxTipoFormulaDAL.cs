...
{
    internal class AuxTipoFormulaDAL
    {
        /// <summary>
        ...
        /// <param name="info">Valores de la entidad</param>
        /// <returns></returns>
        internal static Dictionary<string, object> ObtenerParametrosActualizar(TipoFormulaInfo info)
        {
            try
            {
                Logger.Info();
                var parametros =
                    new Dictionary<string, object>
                        {
							{"@TipoFormulaID", info.TipoFormulaID},
							{"@Descripcion", info.Descripcion},
							{"@Activo", info.Activo},
        ...
        /// </summary>
        /// <param name="tipoFormulaID">Identificador de la entidad TipoFormula</param>
        /// <returns></returns>
        internal static Dictionary<string, object> ObtenerParametrosPorID(int tipoFormulaID)
        {
            try
            {
                Logger.Info();
