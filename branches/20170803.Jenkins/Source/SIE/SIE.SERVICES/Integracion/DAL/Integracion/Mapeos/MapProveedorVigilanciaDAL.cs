...
{
    internal static class MapProveedorVigilanciaDAL
    {
        ...
        /// <summary>
        /// Metodo que obtiene una lista paginada de proveedores por producto
        /// </summary>
        /// <param name="ds"></param>
        /// <returns></returns>
        internal static ResultadoInfo<VigilanciaInfo> ObtenerProveedorProductoPorPagina(DataSet ds)
        {
            ResultadoInfo<VigilanciaInfo> resultado;
            try
            {
