...
{
    internal class AuxProveedorVigilancia
    {
        /// <summary>
        ...
        /// <param name="filtro"></param>
        /// <returns></returns>
        internal static Dictionary<string, object> ObtenerParametrosProveedoresProductoPorPagina(PaginacionInfo pagina, VigilanciaInfo filtro)
        {
            Dictionary<string, object> parametros;
            try
            {
                ...
                parametros = new Dictionary<string, object>
                    {
                        ...
                        {"@Inicio", pagina.Inicio},
                        {"@Limite", pagina.Limite},
                        {"@TipoProveedorID", Convert.ToInt32(TipoProveedorEnum.ProveedoresDeMateriaPrima)},
                        {"@Producto", filtro.Producto == null ? 0 :filtro.Producto.ProductoId}
                    };
            }
            catch (Exception ex)
            {
