...
{
    internal class AuxRotomixDAL
    {
        ///<summary>
        /// Obtiene una lista de la tabla RotoMix para cargar el commobox del mismo nombre "RotoMix"
        /// </summary>
        /// <returns></returns>
        internal static Dictionary<string, object> ObtenerRotoMixXOrganizacionYDescripcion(int organizacionId,string descripcion)
        {
            try
            {
                Logger.Info();
        ...
        /// <param name="info">Valores de la entidad</param>
        /// <returns></returns>
        internal static Dictionary<string, object> ObtenerParametrosActualizar(RotoMixInfo info)
        {
            try
            {
                Logger.Info();
        ...
        /// </summary>
        /// <param name="rotomixID">Identificador de la entidad Rotomix</param>
        /// <returns></returns>
        internal static Dictionary<string, object> ObtenerParametrosPorID(int rotomixID)
        {
            try
            {
                Logger.Info();
