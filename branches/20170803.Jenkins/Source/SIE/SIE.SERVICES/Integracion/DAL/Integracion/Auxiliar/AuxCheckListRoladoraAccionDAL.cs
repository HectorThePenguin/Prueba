...
{
    public class AuxCheckListRoladoraAccionDAL
    {
        /// <summary>
        ...
        /// <param name="info">Valores de la entidad</param>
        /// <returns></returns>
        public static Dictionary<string, object> ObtenerParametrosActualizar(CheckListRoladoraAccionInfo info)
        {
            try
            {
                Logger.Info();
                var parametros =
                    new Dictionary<string, object>
                        {
							{"@CheckListRoladoraAccionID", info.CheckListRoladoraAccionID},
							{"@CheckListRoladoraRangoID", info.CheckListRoladoraRango.CheckListRoladoraRangoID},
							{"@Descripcion", info.Descripcion},
							{"@Activo", info.Activo},
        ...
        /// </summary>
        /// <param name="checkListRoladoraAccionID">Identificador de la entidad CheckListRoladoraAccion</param>
        /// <returns></returns>
        public static Dictionary<string, object> ObtenerParametrosPorID(int checkListRoladoraAccionID)
        {
            try
            {
                Logger.Info();
