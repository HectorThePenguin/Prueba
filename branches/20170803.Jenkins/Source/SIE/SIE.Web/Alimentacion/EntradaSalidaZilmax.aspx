<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EntradaSalidaZilmax.aspx.cs" Inherits="SIE.Web.Alimentacion.EntradaSalidaZilmax" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../Scripts/EntradaSalidaZilmax.js"></script>
                ...
                <div  class="portlet-body form">
                    <div class="row-fluid">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="EntradaSalidaZilmax.aspx"><asp:Label ID="LabelMenu" runat="server" meta:resourcekey="Configuracion_Title"></asp:Label></a> 
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="row-fluid"> 
                        ...
                        <div class="scheduler-border span4">
                            ...
                            <div  class="scheduler-border span12">
                             <table style="width:100%">
                                 <tr>
                                     <td style="text-align:right" >
                                      <button type="button" id="btnSalir" data-toggle="modal" class="btn letra SuKarne">
