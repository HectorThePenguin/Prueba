...
{
    /// <summary>
    /// Lógica de interacción para TratamientoEdicionProducto.xaml
    /// </summary>
    public partial class TratamientoEdicionProducto
    {
        ...
        private void CargarSubFamilias()
        {
            ...
            subFamilias = subFamiliaPL.ObtenerTodos(EstatusEnum.Activo);
        }
