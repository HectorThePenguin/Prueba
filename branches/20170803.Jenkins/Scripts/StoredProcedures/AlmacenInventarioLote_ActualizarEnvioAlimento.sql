...
BEGIN
	...
	SET Cantidad = @Cantidad,
		...
		FechaFin = CASE WHEN @Cantidad = 0 AND @PrecioPromedio = 0 THEN GETDATE() ELSE FechaFin END,
		Activo =  CASE WHEN @Cantidad = 0 AND @PrecioPromedio = 0 THEN @Activo ELSE Activo END,
