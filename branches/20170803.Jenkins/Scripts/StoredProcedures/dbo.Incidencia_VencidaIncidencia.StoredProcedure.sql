USE [SIAP]
GO
/****** Object:  StoredProcedure [dbo].[Incidencia_VencidaIncidencia]    Script Date: 15/10/2015 09:31:44 a.m. ******/
DROP PROCEDURE [dbo].[Incidencia_VencidaIncidencia]
GO
/****** Object:  StoredProcedure [dbo].[Incidencia_VencidaIncidencia]    Script Date: 15/10/2015 09:31:44 a.m. ******/
SET ANSI_NULLS ON
GO
...
-- Incidencia_VencidaIncidencia  1,59
--=============================================
CREATE PROCEDURE [dbo].[Incidencia_VencidaIncidencia] 
@IncidenciaID INT,
@EstatusID INT,
@HorasRespuesta INT,
