...
{
    public class TipoCreditoInfo : INotifyPropertyChanged
    {
        ...
        public int TipoCreditoID
        {
            get { return tipoCreditoID; }
            set
            {
                tipoCreditoID = value;
                NotifyPropertyChanged("TipoCreditoID");
            }
        }
