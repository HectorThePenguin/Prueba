...
{
    internal class AuxConfiguracionSemanaDAL
    {
        /// <summary>
        ...
        /// <returns></returns>
        internal static Dictionary<string, object> ObtenerParametrosPorPagina(PaginacionInfo pagina, ConfiguracionSemanaInfo filtro)
        {
            try
            {
                Logger.Info();
                var parametros =
                    new Dictionary<string, object>
                        {
                            {"@ConfiguracionSemanaID", filtro.ConfiguracionSemanaID},
        ...
        /// <param name="info">Valores de la entidad</param>
        /// <returns></returns>
        internal static Dictionary<string, object> ObtenerParametrosActualizar(ConfiguracionSemanaInfo info)
        {
            try
            {
                Logger.Info();
                var parametros =
                    new Dictionary<string, object>
                        {
							{"@ConfiguracionSemanaID", info.ConfiguracionSemanaID},
							{"@OrganizacionID", info.Organizacion.OrganizacionID},
							{"@InicioSemana", info.InicioSemana.ToString()},
							{"@FinSemana", info.FinSemana.ToString()},
							{"@Activo", info.Activo},
        ...
        /// </summary>
        /// <param name="configuracionSemanaID">Identificador de la entidad ConfiguracionSemana</param>
        /// <returns></returns>
        internal static Dictionary<string, object> ObtenerParametrosPorID(int configuracionSemanaID)
        {
            try
            {
                Logger.Info();
                var parametros = 
                    new Dictionary<string, object>
                        {
                            {"@ConfiguracionSemanaID", configuracionSemanaID}
                        };
                return parametros;
            }
            catch (Exception ex)
        ...
        internal static Dictionary<string, object> ObtenerParametrosPorDescripcion(string descripcion)
        {
            try
            {
                ...
                var parametros = 
                        new Dictionary<string, object>
                            {
								{"@ConfiguracionSemanaID", descripcion}
                            };
                return parametros;
            }
            catch (Exception ex)
