...
{
    public class AuxCamionRepartoDAL
    {
        /// <summary>
        ...
        /// <param name="info">Valores de la entidad</param>
        /// <returns></returns>
        public static Dictionary<string, object> ObtenerParametrosActualizar(CamionRepartoInfo info)
        {
            try
            {
                Logger.Info();
        ...
        /// </summary>
        /// <param name="camionRepartoID">Identificador de la entidad CamionReparto</param>
        /// <returns></returns>
        public static Dictionary<string, object> ObtenerParametrosPorID(int camionRepartoID)
        {
            try
            {
                Logger.Info();
        ...
        /// <summary>
        ///  Obtiene Parametros por Organizacion Id
        /// </summary>
        /// <param name="organizacionID">Identificador de la Organizacion</param>
        /// <returns></returns>
        public static Dictionary<string, object> ObtenerParametrosPorOrganizacionID(int organizacionID)
        {
            try
            {
                Logger.Info();
