...
{
    internal class AuxTipoCorralDAL
    {
        /// <summary>
        ...
        /// <param name="info">Valores de la entidad</param>
        /// <returns></returns>
        internal static Dictionary<string, object> ObtenerParametrosActualizar(TipoCorralInfo info)
        {
            try
            {
                Logger.Info();
                var parametros =
                    new Dictionary<string, object>
                        {
							{"@TipoCorralID", info.TipoCorralID},
							{"@Descripcion", info.Descripcion},
							{"@Activo", info.Activo},
        ...
        /// </summary>
        /// <param name="tipoCorralID">Identificador de la entidad TipoCorral</param>
        /// <returns></returns>
        internal static Dictionary<string, object> ObtenerParametrosPorID(int tipoCorralID)
        {
            try
            {
                Logger.Info();
