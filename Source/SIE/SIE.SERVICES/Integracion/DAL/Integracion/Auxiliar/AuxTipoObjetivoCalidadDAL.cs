...
{
    public class AuxTipoObjetivoCalidadDAL
    {
        /// <summary>
        ...
        /// <param name="info">Valores de la entidad</param>
        /// <returns></returns>
        public static Dictionary<string, object> ObtenerParametrosActualizar(TipoObjetivoCalidadInfo info)
        {
            try
            {
                Logger.Info();
                var parametros =
                    new Dictionary<string, object>
                        {
							{"@TipoObjetivoCalidadID", info.TipoObjetivoCalidadID},
							{"@Descripcion", info.Descripcion},
							{"@Activo", info.Activo},
        ...
        /// </summary>
        /// <param name="tipoObjetivoCalidadID">Identificador de la entidad TipoObjetivoCalidad</param>
        /// <returns></returns>
        public static Dictionary<string, object> ObtenerParametrosPorID(int tipoObjetivoCalidadID)
        {
            try
            {
                Logger.Info();
