...
{
    internal static class AuxTipoPolizaDAL
    {
        /// <summary>
        ...
        /// <returns></returns>
        internal static Dictionary<string, object> ObtenerParametrosPorPagina(PaginacionInfo pagina, TipoPolizaInfo filtro)
        {
            try
            {
                Logger.Info();
        ...
        /// <param name="info">Valores de la entidad</param>
        /// <returns></returns>
        internal static Dictionary<string, object> ObtenerParametrosActualizar(TipoPolizaInfo info)
        {
            try
            {
                Logger.Info();
                var parametros =
                    new Dictionary<string, object>
                        {
                            {"@TipoPolizaID", info.TipoPolizaID},
                            {"@Descripcion", info.Descripcion},
                            {"@ClavePoliza", info.ClavePoliza},
                            {"@Activo", info.Activo},
        ...
        /// <returns></returns>
        internal static Dictionary<string, object> ObtenerParametrosPorID(int tipoPolizaID)
        {
            try
            {
                Logger.Info();
