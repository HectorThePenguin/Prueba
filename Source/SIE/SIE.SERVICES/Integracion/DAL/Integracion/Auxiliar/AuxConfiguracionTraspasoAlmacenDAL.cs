...
{
    public class AuxConfiguracionTraspasoAlmacenDAL
    {
        /// <summary>
        ...
        /// <param name="info">Valores de la entidad</param>
        /// <returns></returns>
        public static Dictionary<string, object> ObtenerParametrosActualizar(ConfiguracionTraspasoAlmacenInfo info)
        {
            try
            {
                Logger.Info();
                var parametros =
                    new Dictionary<string, object>
                        {
							{"@ConfiguracionTraspasoAlmacenID", info.ConfiguracionTraspasoAlmacenID},
							{"@TipoAlmacenOrigenID", info.TipoAlmacenOrigen.TipoAlmacenID},
							{"@TipoAlmacenDestinoID", info.TipoAlmacenDestino.TipoAlmacenID},
                            {"@DiferenteOrganizacion", info.DiferenteOrganizacion},
							{"@Activo", info.Activo},
        ...
        /// </summary>
        /// <param name="configuracionTraspasoAlmacenID">Identificador de la entidad ConfiguracionTraspasoAlmacen</param>
        /// <returns></returns>
        public static Dictionary<string, object> ObtenerParametrosPorID(int configuracionTraspasoAlmacenID)
        {
            try
            {
                Logger.Info();
                var parametros = 
                    new Dictionary<string, object>
                        {
                            {"@ConfiguracionTraspasoAlmacenID", configuracionTraspasoAlmacenID}
                        };
                return parametros;
            }
            catch (Exception ex)
        ...
        public static Dictionary<string, object> ObtenerParametrosPorDescripcion(string descripcion)
        {
            try
            {
                ...
                var parametros = 
                        new Dictionary<string, object>
                            {
								{"@ConfiguracionTraspasoAlmacenID", descripcion}
                            };
                return parametros;
            }
            catch (Exception ex)
