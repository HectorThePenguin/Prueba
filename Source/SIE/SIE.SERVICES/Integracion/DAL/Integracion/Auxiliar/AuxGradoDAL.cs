...
namespace SIE.Services.Integracion.DAL.Integracion.Auxiliar
{
    public class AuxGradoDAL
    {
        ...
        /// <param name="info">Valores de la entidad</param>
        /// <returns></returns>
        public static Dictionary<string, object> ObtenerParametrosActualizar(GradoInfo info)
        {
            try
            {
                Logger.Info();
        ...
        /// </summary>
        /// <param name="gradoID">Identificador de la entidad Grado</param>
        /// <returns></returns>
        public static Dictionary<string, object> ObtenerParametrosPorID(int gradoID)
        {
            try
            {
                Logger.Info();
