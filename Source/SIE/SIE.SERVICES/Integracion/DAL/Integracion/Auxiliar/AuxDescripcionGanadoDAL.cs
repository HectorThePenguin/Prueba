...
{
    public class AuxDescripcionGanadoDAL
    {
        /// <summary>
        ...
        /// <param name="info">Valores de la entidad</param>
        /// <returns></returns>
        public static Dictionary<string, object> ObtenerParametrosActualizar(DescripcionGanadoInfo info)
        {
            try
            {
                Logger.Info();
                var parametros =
                    new Dictionary<string, object>
                        {
							{"@DescripcionGanadoID", info.DescripcionGanadoID},
							{"@Descripcion", info.Descripcion},
							{"@Activo", info.Activo},
        ...
        /// </summary>
        /// <param name="descripcionGanadoID">Identificador de la entidad DescripcionGanado</param>
        /// <returns></returns>
        public static Dictionary<string, object> ObtenerParametrosPorID(int descripcionGanadoID)
        {
            try
            {
                Logger.Info();
                var parametros = 
                    new Dictionary<string, object>
                        {
                            {"@DescripcionGanadoID", descripcionGanadoID}
                        };
                return parametros;
            }
            catch (Exception ex)
