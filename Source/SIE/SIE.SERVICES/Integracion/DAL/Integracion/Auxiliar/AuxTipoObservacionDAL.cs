...
{
    internal class AuxTipoObservacionDAL
    {
        /// <summary>
        ...
        /// <param name="info">Valores de la entidad</param>
        /// <returns></returns>
        internal static Dictionary<string, object> ObtenerParametrosActualizar(TipoObservacionInfo info)
        {
            try
            {
                Logger.Info();
                var parametros =
                    new Dictionary<string, object>
                        {
							{"@TipoObservacionID", info.TipoObservacionID},
							{"@Descripcion", info.Descripcion},
        ...
        /// </summary>
        /// <param name="tipoObservacionID">Identificador de la entidad TipoObservacion</param>
        /// <returns></returns>
        internal static Dictionary<string, object> ObtenerParametrosPorID(int tipoObservacionID)
        {
            try
            {
                Logger.Info();
