...
namespace SIE.Services.Integracion.DAL.Integracion.Mapeos
{
    class MAPPlacasVigilanciaDAL
    {
        ...
        /// <param name="ds"></param>
        /// <returns></returns>
        internal static ResultadoInfo<VigilanciaInfo> ObtenerCamionPorPagina(DataSet ds)
        {
            ResultadoInfo<VigilanciaInfo> resultado;
            try
            {
                ...
                List<VigilanciaInfo> lista =
                    (from info in dt.AsEnumerable()
                     select
                            new VigilanciaInfo
                            {
                                ID = info.Field<int>("CamionID"),
                                Descripcion = info.Field<string>("PlacaCamion"),
                                Activo = info.Field<bool>("Activo").BoolAEnum(),
                            }
                    ).ToList();
