...
{
    public partial class TipoGanadoCentros
    {
        #region Propiedades
        /// <summary>
        ...
        private void BtnNuevo_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                var tipoGanadoCentrosEdicion = new TipoGanadoCentrosEdicion
                {
                    ucTitulo = { TextoTitulo = Properties.Resources.TipoGanado_Nuevo_Titulo }
                };
                MostrarCentrado(tipoGanadoCentrosEdicion);
        ...
        private void BtnEditar_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    var tipoGanadoCentrosEdicion = new TipoGanadoCentrosEdicion(tipoGanadoInfoSelecionado)
                        {
        ...
        private void ObtenerListaTipoGanado(int inicio, int limite)
        {
            try
            {
                ...
                ResultadoInfo<TipoGanadoInfo> resultadoInfo = tipoGanadoPL.Centros_ObtenerPorPagina(pagina, filtros);
                ...
                else
                {
                    ...
                    gridDatos.ItemsSource = new List<TipoGanadoCentros>();
                }
            }
            catch (ExcepcionGenerica)
            {
