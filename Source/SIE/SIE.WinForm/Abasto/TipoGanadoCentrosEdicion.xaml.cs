...
{
    public partial class TipoGanadoCentrosEdicion
    {
        #region Propiedades
        ...
        /// </summary>
        public TipoGanadoCentrosEdicion()
        {
            InitializeComponent();
            InicializaContexto();
        }
        ...
        public TipoGanadoCentrosEdicion(TipoGanadoInfo tipoGanadoInfo)
        {
           InitializeComponent();
        ...
        private bool ValidaGuardar()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    TipoGanadoInfo tipoGanado = tipoGanadoPL.Centros_ObtenerPorDescripcion(descripcion);
        ...
        private void Guardar()
        {
            ...
            if (guardar)
            {
                ...
                {
                    var tipoGanadoPL = new TipoGanadoPL();
                    tipoGanadoPL.Centros_Guardar(Contexto);
