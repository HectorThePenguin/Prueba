<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalidaIndividualRecuperacion.aspx.cs" Inherits="SIE.Web.Sanidad.SalidaIndividualRecuperacion" culture="auto" uiculture="auto" meta:resourcekey="SalidaIndividualRecuperacion" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script src="../Scripts/SalidaIndividualRecuperacion.js"></script>
    ...
    <script type="text/javascript">
        ...
        var msgNoCorraletaManejo = '<asp:Literal runat="server" Text="<%$ Resources:msgNoCorraletaManejo.Text %>"/>';
        ...
        var msgAreteMayorDias = '<asp:Literal runat="server" Text="<%$ Resources:msgAreteMayorDias.Text %>"/>';
        
        var msgNoInventario = '<asp:Literal runat="server" Text="<%$ Resources:msgNoInventario.Text %>"/>';
        var msgAreteDetectadoMuerto = '<asp:Literal runat="server" Text="<%$ Resources:msgAreteDetectadoMuerto %>"/>';
    </script>
    <style type="text/css">
        input[type=radio] {
            margin-top: 0;
                ...
                <div class="span12">
                    <div class="portlet box SuKarne2">
                        ...
                        <div class="portlet-body form">
                            ...
                            <fieldset class="scheduler-border">
                                ...
                                <div class="span12">
                                    <div class="span4">
                                        ...
                                        <div class="span12">
                                            <label><asp:RadioButton ID="rdSalidaRecuperacion" runat="server" Enabled="false" Checked="true" GroupName="radios" TextAlign="Right"/>Salida por recuperación</label>
                                        </div>
                                    </div>
                                    <div class="span4">
                                        <div class="space10"></div>
                            ...
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">Salida individual ganado - por recuperación</legend>
                            <div class="span12">
                                <div class="span4">
                                    <div class="space10"></div>
                                ...
                                <div class="span4">
                                    ...
                                    <div class="span7">
                                        <asp:TextBox ID="txtCorral" runat="server" class="span12" ReadOnly="true"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="span4 no-left-margin">
                                    ...
                                    <div class="span7">
                                        <select id="ddlCorralDestino" class="span12"></select>
                                        <%--<input id="txtCorraleta" class="span12 text-right" type="text"/>--%>
                                        <%--<asp:TextBox ID="txtCorraleta" runat="server" class="span12"></asp:TextBox>--%>
                                    </div>
                                </div>
                            </div>
                            </fieldset>
