<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AsignacionDeLoteEnPatio.aspx.cs" Inherits="SIE.Web.MateriaPrima.AsignacionDeLoteEnPatio" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../Scripts/AsignacionDeLoteEnPatio.js"></script>
    <link href="../assets/css/AsignacionDeLoteEnPatio.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        ...
        var mensajeElFolioTieneLoteAsignado = '<asp:Literal runat="server" Text="<%$ Resources:mensajeElFolioTieneLoteAsignado %>"/>';
        var mensajeEsNecesarioSeleccionarUnLote = '<asp:Literal runat="server" Text="<%$ Resources:mensajeEsNecesarioSeleccionarUnLote %>"/>';
    </script>
</head>
<body>
                ...
                <div class="portlet-body form">
                    <div class="row-fluid">
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="../MateriaPrima/AsignacionDeLoteEnPatio.aspx"><asp:Label ID="Label1" runat="server" meta:resourcekey="lblTitulo"></asp:Label></a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="span12">
                                <div class="span6">
                                    ...
                                    <div class="span10">
                                        ...
                                        <div class="span2">
                                            <button type="button" id="btnLoteAlmacen" class="btn SuKarne span12">
                                                <i class="icon-plus"></i>
                                            </button>
                                        </div>
                                        <div class="span2">
                                            <button type="button" id="btnBuscarLoteAlmacen" class="btn SuKarne span12">
                                                <i class="icon-search"></i>
                                            </button>
                                        </div>
                                    </div>
                                    <div class="span10">
                                        ...
                                        <div class="span2">
                                            <button type="button" id="btnLoteProceso" class="btn SuKarne span12">
                                                <i class="icon-plus"></i>
                                            </button>
                                        </div>
                                        <div class="span2">
                                            <button type="button" id="btnBuscarLoteProceso" class="btn SuKarne span12">
                                                <i class="icon-search"></i>
                                            </button>
                                        </div>
                                    </div>
                                    <div class="span10">
                                        ...
                                        <div class="span2">
                                            <button type="button" id="btnBodegaExterna" class="btn SuKarne span12">
                                                <i class="icon-plus"></i>
                                            </button>
                                        </div>
                                        <div class="span2">
                                            <button type="button" id="btnBuscarBodegaExterna" class="btn SuKarne span12">
                                                <i class="icon-search"></i>
                                            </button>
                                        </div>
                                    </div>
